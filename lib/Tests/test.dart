...
void main() {
  test(
    ...
    () {
      ...
      _queue.add(Item(SvgPicture.asset("assets/onboarding/onboard1.svg"),
          "Title 1", "Subtitle 1"));
      _queue.add(Item(SvgPicture.asset("assets/onboarding/onboard2.svg"),
          "Title 2", "Subtitle 2"));
      _queue.add(Item(SvgPicture.asset("assets/onboarding/onboard3.svg"),
          "Title 3", "Subtitle 3"));
      _queue.add(Item(SvgPicture.asset("assets/onboarding/onboard4.svg"),
          "Title 4", "Subtitle 4"));
